...
import com.vdev.microservice.config.KafkaSseConsumer;
import com.vdev.microservice.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/iam-service-kafka")
public class IamServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(IamServiceKafkaResource.class);
    ...
    public IamServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
